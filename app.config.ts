...
const PROJECT_SLUG = "note-react-native";
const OWNER = "skhmelyuk";

// Production конфігурація (базова)
const APP_NAME = "Note";
const BUNDLE_IDENTIFIER = "com.skhmelyuk.notereactnative";
const PACKAGE_NAME = "com.skhmelyuk.notereactnative";
const SCHEME = "notereactnative";
